	...
	.text
.Ltext0:
	.section	.text.hal_iface_init,"ax",%progbits
	.align	1
	.global	hal_iface_init
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	hal_iface_init, %function
hal_iface_init:
.LFB0:
	.file 1 "C:\\localrep\\ATEC608A_test\\nRF5_SDK_15.3.0_59ac345\\examples\\iot\\misc\\iot_timer\\cryptoauthlib\\lib\\hal\\atca_hal.c"
	.loc 1 45 0
...
.L6:
	.word	hal_swi_init
	.word	hal_swi_post_init
	.word	hal_swi_receive
	.word	hal_swi_send
	.word	hal_swi_sleep
	.word	hal_swi_wake
	.word	hal_swi_idle
	.word	hal_swi_release
.LFE0:
	.size	hal_iface_init, .-hal_iface_init
	.section	.text.hal_iface_release,"ax",%progbits
	.align	1
	.global	hal_iface_release
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	hal_iface_release, %function
hal_iface_release:
.LFB1:
	.loc 1 150 0
	@ args = 0, pretend = 0, frame = 0
...
.LVL8:
	bx	lr
.LFE1:
	.size	hal_iface_release, .-hal_iface_release
	.section	.text.hal_check_wake,"ax",%progbits
	.align	1
	.global	hal_check_wake
	.syntax unified
	.thumb
	.thumb_func
	.fpu fpv4-sp-d16
	.type	hal_check_wake, %function
hal_check_wake:
.LFB2:
	.loc 1 204 0
...
.L17:
	.word	.LANCHOR0
.LFE2:
	.size	hal_check_wake, .-hal_check_wake
	.section .rodata
	.set	.LANCHOR0,. + 0
.LC0:
	.byte	4
...
.Letext0:
	...
	.file 4 "../../../cryptoauthlib/lib/atca_status.h"
	.file 5 "../../../cryptoauthlib/lib/atca_devtypes.h"
	.file 6 "../../../cryptoauthlib/lib/atca_command.h"
	.file 7 "../../../cryptoauthlib/lib/atca_iface.h"
	.file 8 "../../../cryptoauthlib/lib/hal/atca_hal.h"
	.file 9 "../../../cryptoauthlib/lib/atca_device.h"
	.file 10 "../../../cryptoauthlib/lib/atca_cfgs.h"
	.file 11 "../../../cryptoauthlib/lib/basic/atca_basic.h"
	.file 12 "../../../cryptoauthlib/lib/basic/atca_helpers.h"
...
.Ldebug_macro0:
	...
	.uleb128 0
	.uleb128 0x1
	.file 14 "../../../cryptoauthlib/lib/cryptoauthlib.h"
	.byte	0x3
	.uleb128 0x23
	.uleb128 0xe
	.byte	0x5
	.uleb128 0x1d
	.4byte	.LASF453
	.file 15 "C:/Program Files/SEGGER/SEGGER Embedded Studio for ARM 3.40/include/stddef.h"
	.byte	0x3
	.uleb128 0x1f
	.uleb128 0xf
	.byte	0x5
	...
	.uleb128 0xe
	.byte	0x4
	.file 21 "../../../cryptoauthlib/lib/crypto/atca_crypto_sw_sha2.h"
	.byte	0x3
	.uleb128 0x21
	.uleb128 0x15
	.byte	0x5
	.uleb128 0x1d
	.4byte	.LASF1000
	.file 22 "../../../cryptoauthlib/lib/crypto/atca_crypto_sw.h"
	.byte	0x3
	.uleb128 0x1f
	.uleb128 0x16
	.byte	0x5
